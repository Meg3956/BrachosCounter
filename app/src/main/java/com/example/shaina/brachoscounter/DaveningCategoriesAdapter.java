 ...
 */
    ...
    public class DaveningCategoriesAdapter extends BaseExpandableListAdapter
    {
        ...
        */
        public DaveningCategoriesAdapter (Context context, ArrayList<String> listDataGroup,
        ...
        */
                                  ...
                                  View convertView, ViewGroup parent)
        {
            ...
            if (convertView == null) {
                ...
                convertView = inflater.inflate (R.layout.davening_list_group, null);
                                  ...
                                  View convertView, ViewGroup parent)
        {
            ...
            if (convertView == null) {
                ...
                LayoutInflater inflater = (LayoutInflater) this.mContext
                        .getSystemService (Context.LAYOUT_INFLATER_SERVICE);
                convertView = inflater.inflate (R.layout.davening_list_item, parent, false);
                ...
                convertView.setTag (R.layout.davening_list_item, childViewHolder);

            }
            else {

                childViewHolder = (ChildViewHolder) convertView
                        .getTag (R.layout.davening_list_item);
            }
